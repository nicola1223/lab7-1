...
function func(index){
    ...
    let text = ''
    let navClassList = document.getElementsByClassName("navigation")[0].classList
    navClassList.remove(navClassList.item(1))
    let mainClassList = document.getElementsByClassName("main")[0].classList
    mainClassList.remove(mainClassList.item(1))
    let quoteClassList = document.getElementsByClassName("quote")[0].classList
    quoteClassList.remove(quoteClassList.item(1))
    let standClassList = document.getElementsByClassName("stand")[0].classList
    standClassList.remove(standClassList.item(1))
    if (last_class){
        document.getElementsByClassName(last_class)[0].style.display = "none"
        document.getElementsByClassName(last_class)[1].style.display = "none"
    }
    switch (index){
        case 0:
            document.getElementsByClassName("jonatan__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("jonatan__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "No name"
            last_class = "jonatan__stand"
            document.getElementsByClassName("stand")[0].classList.add("jonatan")
            document.getElementsByClassName("quote")[0].classList.add("jonatan")
            document.getElementsByClassName("main")[0].classList.add("jonatan")
            document.getElementsByClassName("navigation")[0].classList.add("jonatan")
            audio = document.getElementById("Jonatan")
            text = "1 часть: Phantom Blood"
            break
        case 1:
            document.getElementsByClassName("jozeph__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("jozeph__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Hermit Purple"
            last_class = "jozeph__stand"
            document.getElementsByClassName("stand")[0].classList.add("jozeph")
            document.getElementsByClassName("quote")[0].classList.add("jozeph")
            document.getElementsByClassName("main")[0].classList.add("jozeph")
            document.getElementsByClassName("navigation")[0].classList.add("jozeph")
            audio = document.getElementById("Jozeph")
            text = "2 часть: Battle Tendency"
            break
        case 2:
            document.getElementsByClassName("jotaro__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("jotaro__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Star Platinum"
            last_class = "jotaro__stand"
            document.getElementsByClassName("stand")[0].classList.add("jotaro")
            document.getElementsByClassName("quote")[0].classList.add("jotaro")
            document.getElementsByClassName("main")[0].classList.add("jotaro")
            document.getElementsByClassName("navigation")[0].classList.add("jotaro")
            audio = document.getElementById("Jotaro")
            text = "3 часть: Stardust Crusaders"
            break
        case 3:
            document.getElementsByClassName("josuke__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("josuke__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Crazy Diamond"
            last_class = "josuke__stand"
            document.getElementsByClassName("stand")[0].classList.add("josuke")
            document.getElementsByClassName("quote")[0].classList.add("josuke")
            document.getElementsByClassName("main")[0].classList.add("josuke")
            document.getElementsByClassName("navigation")[0].classList.add("josuke")
            audio = document.getElementById("Josuke")
            text = "4 часть: Diamond Is Unbreakable"
            break
        case 4:
            document.getElementsByClassName("jorno__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("jorno__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Gold Experience"
            last_class = "jorno__stand"
            document.getElementsByClassName("stand")[0].classList.add("jorno")
            document.getElementsByClassName("quote")[0].classList.add("jorno")
            document.getElementsByClassName("main")[0].classList.add("jorno")
            document.getElementsByClassName("navigation")[0].classList.add("jorno")
            audio = document.getElementById("Jorno")
            text = "5 часть: Golden Wind"
            break
        case 5:
            document.getElementsByClassName("jolin__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("jolin__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Stone Free"
            last_class = "jolin__stand"
            document.getElementsByClassName("stand")[0].classList.add("jolin")
            document.getElementsByClassName("quote")[0].classList.add("jolin")
            document.getElementsByClassName("main")[0].classList.add("jolin")
            document.getElementsByClassName("navigation")[0].classList.add("jolin")
            audio = document.getElementById("Jolin")
            text = "6 часть: Stone Ocean"
            break
        case 6:
            document.getElementsByClassName("johnny__stand")[0].style.display = "inline-block";
            document.getElementsByClassName("johnny__stand")[1].style.display = "inline-block";
            document.getElementsByClassName("stand__name")[0].getElementsByTagName("p")[0].innerHTML = "Task Akt 4"
            last_class = "johnny__stand"
            document.getElementsByClassName("stand")[0].classList.add("johnny")
            document.getElementsByClassName("quote")[0].classList.add("johnny")
            document.getElementsByClassName("main")[0].classList.add("johnny")
            document.getElementsByClassName("navigation")[0].classList.add("johnny")
            audio = document.getElementById("Johnny")
            text = "7 часть: Steel Ball Run"
            break
        case 7:
            text = "8 часть: JoJolion"
            break
    }
